...
/** VECTOR REMAPPING ***********************************************/
	...
	// BPS Change : 02/20/2011
	// For UBW, we want to mimic behavior of all previous UBW HEX files, and have
	// absolutely NO code below 0x800. So this all gets commented out
	#if !defined(UBW)
	...
	// Commented out for UBW (BPS - 06/06/2010)
